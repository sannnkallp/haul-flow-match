...
const Hero = () => {
  return <div className="relative overflow-hidden bg-white py-16 sm:py-24">
      ...
      <div className="absolute top-0 right-0 -z-10 transform-gpu blur-3xl" aria-hidden="true">
        <div className="aspect-[1155/678] w-[36.125rem] bg-gradient-to-tr from-logistics-teal to-logistics-blue opacity-30" style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-lg shadow-xl overflow-hidden animate-fade-up">
            <div className="aspect-w-16 aspect-h-9 lg:aspect-h-10">
              <img src="https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="Logistics truck on highway" className="object-cover w-full h-full rounded-lg" />
              <div className="absolute inset-0 bg-gradient-to-tr from-logistics-blue/40 to-transparent rounded-lg"></div>
            </div>
            
            {/* Floating card */}
            <div className="absolute bottom-6 right-6 bg-white rounded-lg shadow-lg p-4 max-w-xs animate-fade-up" style={{
            animationDelay: "0.3s"
          }}>
